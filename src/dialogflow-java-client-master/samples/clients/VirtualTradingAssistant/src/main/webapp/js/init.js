    ...
    $(".queryForm").submit(function(event) {
        ...
        if (inputText.length > 0) {
            ...
            if(inputText.toLowerCase().indexOf("notification") != -1) {
                if(inputText.toLowerCase().indexOf("min")) {
                    console.log("made it");
            ...
            if(inputText.toLowerCase().indexOf("news") != -1) {
                if(inputText.toLowerCase().indexOf("minutes") != -1 || inputText.toLowerCase().indexOf("mins") != -1) {
                ...
                if(inputText.toLowerCase().indexOf("secs") != -1 || inputText.toLowerCase().indexOf("seconds") != -1) {
